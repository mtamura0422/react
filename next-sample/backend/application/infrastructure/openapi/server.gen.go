...
type ServerInterface interface {
	...
	// レシピ一覧取得
	// (GET /recipe/list)
	GetRecipeList(w http.ResponseWriter, r *http.Request, params GetRecipeListParams)
	// 新規レシピ登録
...
// レシピ一覧取得
// (GET /recipe/list)
func (_ Unimplemented) GetRecipeList(w http.ResponseWriter, r *http.Request, params GetRecipeListParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// レシピ取得
// (GET /recipe/{recipeId})
func (_ Unimplemented) GetRecipe(w http.ResponseWriter, r *http.Request, recipeId int64) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetRecipeList operation middleware
func (siw *ServerInterfaceWrapper) GetRecipeList(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params GetRecipeListParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetRecipeList(w, r, params)
	}))
...
// RegisterRecipe operation middleware
func (siw *ServerInterfaceWrapper) RegisterRecipe(w http.ResponseWriter, r *http.Request) {
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/", wrapper.GetVersion)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/recipe/list", wrapper.GetRecipeList)
	})
	r.Group(func(r chi.Router) {
